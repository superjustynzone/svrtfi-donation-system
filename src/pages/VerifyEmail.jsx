...
const VerifyEmail = () => {
    ...
    const handleVerify = async (e) => {
        ...
        try {
            setIsLoading(true);
            const response = await axios.post('http://localhost:5000/api/auth_users/verify', {
                email: email,
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-[#63A6B2] p-4">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 text-center animate-in fade-in zoom-in duration-300">
                ...
                {/* Content */}
                <h1 className="text-2xl font-black text-gray-800 mb-2">Verify your Account</h1>
                <p className="text-gray-600 mb-6 leading-relaxed">
                    We've sent a 4-digit verification code to <span className="font-bold text-[#63A6B2]">{email || 'your email'}</span>.
                </p>
                ...
                {/* Footer Note */}
                <div className="mt-10 pt-6 border-t border-gray-100 italic">
