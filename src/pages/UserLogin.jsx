    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#63A6B2] p-4">
      <div className="w-full max-w-4xl bg-white rounded-lg shadow-2xl overflow-hidden flex min-h-[600px]">
        ...
        <div className="w-full md:w-1/2 p-8 pt-16 flex flex-col">
          ...
          {/* Login Form */}
          <form onSubmit={handleSubmit(onSubmit, onError)} className="space-y-4 flex-1" noValidate>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#63A6B2] focus:border-transparent outline-none"
                {...register('email', {
