    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#63A6B2] p-4 py-8">
      <div className="w-full max-w-4xl bg-white rounded-lg shadow-2xl overflow-y-auto overflow-x-hidden flex min-h-[650px] relative">
        ...
        <div className="w-full md:w-1/2 p-8 pt-12 flex flex-col">
          ...
          {/* Sign Up Form */}
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 flex-1" noValidate>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="Juan"
                  className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-[#63A6B2] focus:border-transparent outline-none ${errors.firstName ? 'border-red-500' : 'border-gray-300'
                    }`}
                  {...register('firstName', {
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-[#63A6B2] focus:border-transparent outline-none ${errors.lastName ? 'border-red-500' : 'border-gray-300'
                    }`}
                  {...register('lastName', {
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-[#63A6B2] focus:border-transparent outline-none ${errors.email ? 'border-red-500' : 'border-gray-300'
                  }`}
                {...register('email', {
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-[#63A6B2] focus:border-transparent outline-none ${errors.password ? 'border-red-500' : 'border-gray-300'
                    }`}
                  {...register('password', {
              ...
              {currentPassword && (
                <div className="mt-2">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className={`text-xs font-semibold ${strengthInfo.label === 'Weak' ? 'text-red-500' :
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-[#63A6B2] focus:border-transparent outline-none ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'
                    }`}
